...
def main() -> int:
    ...
    parser.add_argument("--resume", action="store_true", help="resume the latest compatible incomplete run")
    parser.add_argument("--run-id", help="explicit profiling run id (override automatic latest selection)")
